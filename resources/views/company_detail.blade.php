            ...
            <div id="management" style="margin-left: 1%">
                ...
                <div id="phuong" class="phuong" style="width: 98%; margin-left: 0%">
                    <div id="all">
                        ...
                        <br> <br>
                        <form action="{{route('company_detail.post')}}" method="post">
                            {{ csrf_field() }}
                            <table style="width: 50%; float:left">
                                <tr>
                                    <td>Company</td>
                                    <td><input type="text" style="width: 80px;color: gray"
                                               value="{{$company->cpn_id}}" name="cpn_id" readonly>
                                        <input type="text" style="color: gray" name="cpn_name"
                                               value="{{$company->cpn_name}}" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Address</td>
                                    <td>
                                        <input id="address" style="width: 300px" type="text"
                                               value="{{$company->cpn_address}}" name="address" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td><input id="address" type="email" value="{{$company->cpn_email}}" name="email"
                                               required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Phone</td>
                                    <td>
                                        <input id="phone" type="text" value="{{$company->cpn_phone}}" name="phone"
                                               required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Website</td>
                                    <td>
                                        <input type="text" value="{{$company->cpn_website}}" name="website" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Status</td>
