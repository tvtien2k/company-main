                        ...
                        <form action="{{route('branch_register.post')}}" method="post">
                            ...
                            <table style="width: 50%; float:left">
                                ...
                                <tr>
                                    <td>Branch</td>
                                    <td>
                                        <input type="text" placeholder="Please enter Branch name" name="name" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Address</td>
                                ...
                                <tr>
                                    <td>Area</td>
                                    <td>
                                        <input id="area" style="width: 300px" type="text"
                                               placeholder="Please enter Area" name="area" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                            ...
                            <div id="body_button">
                                ...
                                <a href="#" style="text-decoration: none; margin-left: 10px;">
                                    <button type="button" name="back" style="background-color: black">
                                        Back
                                    </button>
                                </a>
                            </div>
