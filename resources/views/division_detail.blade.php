            ...
            <div id="management" style="margin-left: 1%">
                ...
                <div id="phuong" class="phuong" style="width: 98%; margin-left: 0%">
                    <div id="all">
                        ...
                        <br> <br>
                        <form action="{{route('division_detail.post')}}" method="post">
                            {{ csrf_field() }}
                            <table style="width: 50%; float:left">
                                <tr>
                                    <td>Company</td>
                                    <td>
                                        <input type="text" style="width: 80px;color: gray"
                                               value="{{$division->branch->company->cpn_id}}" name="cpn_id" readonly>
                                        <input type="text" style="color: gray"
                                               value="{{$division->branch->company->cpn_name}}" name="cpn_name"
                                               readonly>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" style="width: 80px;color: gray"
                                               value="{{$division->branch->br_id}}" name="br_id"
                                               readonly>
                                        <input type="text" style="color: gray" value="{{$division->branch->br_name}}"
                                               name="name" readonly></td>
                                </tr>
                                <tr>
                                    <td>Division</td>
                                    <td>
                                        <input type="text" style="width: 80px;color: gray" value="{{$division->dvs_id}}"
                                               name="id" readonly>
                                        <input type="text" style="color: gray" value="{{$division->dvs_name}}"
                                               name="name" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="address" style="width: 300px" type="text"
                                               value="{{$division->dvs_address}}" name="address"
                                               required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Area</td>
                                    <td>
                                        <input style="width: 300px" type="text" value="{{$division->dvs_area}}"
                                               name="area" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td>
                                        <input type="email" value="{{$division->dvs_email}}" name="email" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Phone</td>
                                    <td>
                                        <input id="phone" type="text" value="{{$division->dvs_phone}}" name="phone"
                                               required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Website</td>
                                    <td>
                                        <input type="text" value="{{$division->dvs_website}}" name="website" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Status</td>
